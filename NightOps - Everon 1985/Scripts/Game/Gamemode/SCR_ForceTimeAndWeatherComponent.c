...
class SCR_ForceTimeAndWeatherComponent : SCR_BaseGameModeComponent
{
	...
	[Attribute(defvalue: "1", desc: "If enabled, custom weather Id will be used. Authority only.", category: "CaptureAndHold: Environment")]
	...
	[Attribute(defvalue: "Cloudy", desc: "Weather IDs are the same as used in the TimeAndWeatherManager: Clear, Cloudy, Overcast, Rainy. Weather set on game start. Authority only.", category: "CaptureAndHold: Environment")]
	protected string m_sCustomWeatherId;

	//! If enabled custom time of the day will be used on session start. Authority only.
	[Attribute(defvalue: "1", desc: "If enabled, custom time of the day will be used. Authority only.", category: "CaptureAndHold: Environment")]
